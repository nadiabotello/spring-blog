...
values
       ...
       ('sniff', 'Swat at dog plays league of legends yet hell is other people and throw down all the stuff in the kitchen mouse mrow and scamper. Headbutt owner''s knee eat owner''s food or murr i hate humans they are so annoying yet enslave the hooman have a lot of grump in yourself because you can''t forget to be grumpy and not be like king grumpy cat and pee in the shoe. Catto munch salmono ptracy, but sleeps on my head meow go back to sleep owner brings food and water tries to pet on head, so scratch get sprayed by water because bad cat skid on floor, crash into wall chew on cable.', 1),
